    ...
    <header className="sticky top-5 z-50 bg-surface dark:bg-background">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-2 px-6 md:px-8 xl:gap-4">
        ...
        >
          ...
          {/* Both bounds must stay arbitrary min-[]: values — mixing in a named breakpoint (e.g. lg:hidden) doesn't cascade by pixel order and silently breaks the 1100px+ override */}
          <span className="text-sm font-semibold tracking-tight text-text-primary min-[1024px]:hidden min-[1100px]:inline">
            Frontend Forever
          </span>
        </Link>
